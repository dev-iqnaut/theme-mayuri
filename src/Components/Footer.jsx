    ...
    <footer className="bg-white py-8 border-t p-36">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start space-y-4 md:space-y-0">
        ...
        <div className="flex flex-col items-center md:items-start">
          <img src="path/to/logo.png" alt="Ascent Logo" className="w-16 mb-2" />
          <p className="text-center md:text-left text-gray-600 max-w-xs text-sm">
            Yes, there are many notable corporate businesses worldwide.
          </p>
          <div className="flex space-x-4 mt-2">
            <a href=" " className="text-green-600 hover:text-green-800"><FaFacebookF /></a>
            <a href=" " className="text-green-600 hover:text-green-800"><FaTwitter /></a>
            <a href=" " className="text-green-600 hover:text-green-800"><FaLinkedinIn /></a>
            <a href=" " className="text-green-600 hover:text-green-800"><FaPinterest /></a>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <ul className="space-y-1 text-gray-600 text-sm flex flex-col items-start">
