...
import React from 'react';
import { FaFacebookF, FaTwitter, FaLinkedinIn, FaPinterest, FaMapMarkerAlt, FaEnvelope, FaPhone } from 'react-icons/fa'; // Import all necessary icons
  ...
  return (
    <footer className="bg-teal-600 py-8 border-t px-32">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0 p-6 md:p-12">
        ...
        <div className="flex flex-col items-center md:items-start">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQp_lioPzz-gZp3vNwcaFWpFmnAqKxYxryo8Q&s"
            alt="Ascent Logo"
            className="w-16 mb-2"
          />
          <p className="text-center md:text-left text-black max-w-xs text-sm">
