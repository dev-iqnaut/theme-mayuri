      ...
      <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="text-gray-600 mb-8">
            Lorem ipsum dolor sit amet consectetur adipiscing elit platea pharetra, nostra mattis hendrerit proin mollis pretium facilisi in, ligula volutpat.
          </p>
          <a
            href="#"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="bg-green-50 p-4 rounded-full mb-4">
                <img src="https://via.placeholder.com/40" alt="Learning School" />
              </div>
            ...
            >
              <div className="bg-green-50 p-4 rounded-full mb-4">
                <img src="https://via.placeholder.com/40" alt="Learning in the School" />
              </div>
            ...
            >
              <div className="bg-green-50 p-4 rounded-full mb-4">
                <img src="https://via.placeholder.com/40" alt="Stars Preschool" />
              </div>
