...
//         <h1 className="text-2xl md:text-3xl font-bold mt-2 mb-8">Wonderworks Child Development Center Discovery Kids Preschool</h1>
        
//         <div className="grid md:grid-cols-2 gap-6">
//           <div className="grid gap-6">
//             {blogs.slice(0, 2).map((blog) => (
//               <div key={blog.id} className="bg-white rounded-lg shadow-lg p-4 flex flex-col md:flex-row">
//                 <img src={blog.image} alt={blog.title} className="w-full md:w-1/3 rounded-lg object-cover" />
