...
const Testimonial = () => {
  return (
    <div className="relative flex flex-col items-center">
      {/* Title Section */}
      <div className="absolute left-0 top-0 mt-10 ml-4 md:ml-10 z-10 pl-4 md:pl-[100px]">
        <h2 className="text-teal-600 text-base md:text-lg font-semibold">Client's Testimonial</h2>
        <h1 className="text-2xl md:text-4xl font-bold mt-2">Unlocking the Power of Wonderworks Child</h1>
      </div>

      {/* Main Content Section */}
      <div className="relative flex flex-col md:flex-row items-center justify-center mt-32 max-w-6xl mx-auto px-4 md:px-12">
        {/* Image Section */}
        ...
        {/* Testimonial Section (Overlapping Card) */}
        <div className="relative mt-8 md:mt-0 md:absolute md:right-10 top-1/2 transform md:-translate-y-1/2 w-full md:w-1/3 bg-white shadow-md rounded-lg p-8 z-20">
          {/* Quote Sign */}
          <div className="absolute top-4 right-4 text-3xl text-gray-300">
            &ldquo;
          </div>
