...
//                 <div key={image.id || index} style={{ margin: "10px" }}>
//                   <img
//                     src={image.url}
...
const GalleryComponent = () => {
  ...
  return (
    <div className="px-8 py-14 font-sans max-w-screen-lg mx-auto ">
      ...
      {galleryData ? (
        <div>
          {/* Images Section */}
          <h2 className="text-4xl font-bold text-center text-gray-700 mb-6 text-shadow bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent">
            Images
          </h2>
          ...
          {/* Videos Section */}
          <h2 className="text-4xl font-bold text-center text-gray-700 mt-10 mb-6 text-shadow bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent">
            Videos
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-2">
            {galleryData.videos && galleryData.videos.length > 0 ? (
