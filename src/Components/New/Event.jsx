...
//       {/* Adjust the padding for desktop using `lg:px-32` */}
...
//           <div className="bg-gradient-to-r from-teal-400 to-teal-600 text-white rounded-lg shadow-lg p-6 transition-transform duration-500 hover:shadow-2xl hover:scale-105">
...
//           <div className="bg-gradient-to-r from-purple-400 to-purple-600 text-white rounded-lg shadow-lg p-6 transition-transform duration-500 hover:shadow-2xl hover:scale-105">
...
//           {/* News Section */}
//           <div className="bg-gradient-to-r from-indigo-400 to-indigo-600 text-white rounded-lg shadow-lg p-6 transition-transform duration-500 hover:shadow-2xl hover:scale-105">
