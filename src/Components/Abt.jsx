    ...
    <section className="relative flex items-center justify-between py-4 px-6 bg-pink-200 h-48"> {/* Solid baby pink background */}
      ...
      <div className="container mx-auto relative z-10 flex items-center justify-between pl-10 pr-10">
        ...
        <div className="w-1/2 flex justify-center">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStl5gc8Wg4EEzCKyE0eS8SxrYFB6qPZsjSKw&s"
            alt="Boy background"
            className="w-full h-full max-h-44 rounded-lg shadow-md transition-transform transform hover:scale-105 object-cover" 
          />
        </div>
