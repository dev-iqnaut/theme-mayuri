...
//           if (siteData && siteData["aboutUs".trim()]) {
//             setAboutData(siteData["aboutUs".trim()]);
//           } else {
...
//                   {aboutData.principalMessage?.principalMessage || "Principal's message not available."}
//                 </p>
//               </div>
//               {aboutData.principalIessage?.principalImage ? (
//                 <img
//                   src={aboutData.principalMessage.principalImage}
//                   alt="Principal"
        ...
        {aboutData ? (
          <div className="bg-white shadow-2xl rounded-lg p-8 md:p-16 space-y-12 transition duration-500 transform hover:scale-105 hover:shadow-3xl">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-12">
              ...
              {aboutData.principalMessage?.principalImage ? (
                <img
                  src={aboutData.principalMessage.principalImage}
                  alt="Principal"
                  className="rounded-full w-48 h-48 object-cover shadow-lg transform hover:scale-110 transition-transform duration-300"
